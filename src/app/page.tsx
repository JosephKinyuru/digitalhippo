...
const PERKS = [
  ...
  },
  {
    ...
    Icon: CheckCircle,
    description: "Evey asset on our platform is verified by our team to ensure the highest quality standards. Not happy? WE happy a 30-day refund quarantee."
  },
  {
    name: 'For the Planet',
    Icon: Leaf,
    ...
    <MaxWidthWrapper>
      <div className="py-20 mx-auto text-center flex flex-col items-center  max-w-3xl">
        <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
          You're market place for high quality{' '}
          <span className="text-blue-600">digital assets</span> 
        </h1>
        <p className="mt-6 text-lg max-w-prose text-muted-foreground">
          Welocome to DigitalHippo. Every asset on our platform is veryfied by our team to ensure our highest quality standards.
        </p>
